...
public class LobbyPanel extends JPanel{
	...
	private void createGUI() {
		...
		firmLabel.setForeground(Constants.darkGray);
		...
		statusLabel.setForeground(Constants.offWhite);
	...
	public void makeButton(JButton... button) {
		for (JButton b : button) {
			b.setBackground(Constants.darkGray);
			b.setForeground(Constants.offWhite);
	...
	public void addPlayer(JPanel member, String name, String firm) {
		...
		username.setForeground(Constants.offWhite);
		JLabel firmName = new JLabel(firm);
		firmName.setFont(new Font("Arial", Font.PLAIN, 28));
		firmName.setForeground(Constants.offWhite);
