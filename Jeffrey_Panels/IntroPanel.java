...
public class IntroPanel extends JPanel {
	...
	private void createGUI() {
		...
		eastPanel.setBackground(Constants.offWhite);
		...
		southPanel.setBackground(Constants.darkBlue);
	...
	public void makeButton(JButton... button) {
		for (JButton b : button) {
			b.setBackground(Constants.offWhite);
			b.setForeground(Constants.darkBlue);
	...
	public void addToInfo(JComponent jc) {
		...
		jc.setForeground(Constants.darkGray);
	...
	public void addLobby(String name) {
		...
		lobbyName.setForeground(Constants.offWhite);
		
		lobbyPanel.add(lobbyName);
		lobbyPanel.add(Box.createHorizontalGlue());
		
		JButton selectButton = new JButton("Select");
		selectButton.setForeground(Constants.offWhite);
		selectButton.setBackground(Constants.darkGray);
		...
		separator.setBackground(Constants.offWhite);
